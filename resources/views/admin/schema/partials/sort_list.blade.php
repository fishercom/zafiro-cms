  ...
  <div class="modal fade" id="sort_modal" tabindex="-1" role="dialog" aria-labelledby="sortLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        {!! Form::open(['url' => 'admin/schema/sort', 'method'=>'POST', 'class'=>'form-horizontal']) !!}
          ...
          <div class="modal-body">
            ...
            <div class="container">
              ...
              @foreach ($schemas as $schema)
                <li rel="{{ $schema->id }}">&Colon; {{ $schema->name }}<input type="hidden" name="sortlist[]" value="{{ $schema->id }}"></li>
              @endforeach
              </ol>
            </div>
          </div>
